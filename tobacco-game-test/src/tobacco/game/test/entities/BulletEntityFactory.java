...
public class BulletEntityFactory {
	...
	public Entity create(Vector2D pos, BulletComponent b) {
		...
		DrawableComponent drawComp = new DrawableComponent(b.getBulletData()
				.getTexture(), b.getBulletData().getSize());
		...
		entity.putComponent(new RotationComponent(90f + Vector2D.angle(
				Vector2D.VERTICAL, dir).getDegrees()));
